...
var GameLayer = cc.Layer.extend({
    ...
    addListener: function () {
        ...
        if("touches" in cc.sys.capabilities){
            cc.eventManager.addListener(this.touchListener, this.mapPanel);
        } else {
            cc.eventManager.addListener(this.mouseListener, this.mapPanel);
        }
    },
    ...
    doClear: function(conduit){
        switch(conduit.type){
            case 1: if(conduit.fixed) conduit.setTexture(res.curly_fixed);
                    else conduit.setTexture(res.curly_png);
                    conduit.rotation = 0;break;
            case 2: if(conduit.fixed) conduit.setTexture(res.curly_fixed);
                    else conduit.setTexture(res.curly_png);
                    conduit.rotation = 90;break;
            case 3: if(conduit.fixed) conduit.setTexture(res.curly_fixed);
                    else conduit.setTexture(res.curly_png);
                    conduit.rotation = 180;break;
            case 4: if(conduit.fixed) conduit.setTexture(res.curly_fixed);
                    else conduit.setTexture(res.curly_png);
                    conduit.rotation = 270;break;
            case 5: if(conduit.fixed) conduit.setTexture(res.straight_fixed);
                    else conduit.setTexture(res.straight_png);
                    conduit.rotation = 90;break;
            case 6: if(conduit.fixed) conduit.setTexture(res.straight_fixed);
                    else conduit.setTexture(res.straight_png);
                    conduit.rotation = 0;break;
            default: break;
        }
    ...
    doLight: function(conduit){
        switch(conduit.type){
            case 1: if(conduit.fixed) conduit.setTexture("res/lightPic/curly_fixed_light.png");
                    else conduit.setTexture("res/lightPic/curly_light.png");
                    conduit.rotation = 0;break;
            case 2: if(conduit.fixed) conduit.setTexture("res/lightPic/curly_fixed_light.png");
                    else conduit.setTexture("res/lightPic/curly_light.png");
                    conduit.rotation = 90;break;
            case 3: if(conduit.fixed) conduit.setTexture("res/lightPic/curly_fixed_light.png");
                    else conduit.setTexture("res/lightPic/curly_light.png");
                    conduit.rotation = 180;break;
            case 4: if(conduit.fixed) conduit.setTexture("res/lightPic/curly_fixed_light.png");
                    else conduit.setTexture("res/lightPic/curly_light.png");
                    conduit.rotation = 270;break;
            case 5: if(conduit.fixed) conduit.setTexture("res/lightPic/straight_fixed_light.png");
                    else conduit.setTexture("res/lightPic/straight_light.png");
                    conduit.rotation = 90;break;
            case 6: if(conduit.fixed) conduit.setTexture("res/lightPic/straight_fixed_light.png");
                    else conduit.setTexture("res/lightPic/straight_light.png");
                    conduit.rotation = 0;break;
            default: break;
        }
...
///////////////////////////--------左侧变色--------------------////////////////////////////
//            if(left.fixed){
//                left.setTexture("res/lightPic/curly_fixed_light.png");
//            }else{
//                left.setTexture("res/lightPic/curly_light.png");
//            }
//            left.setRotation(90);
//////////////////////////-----------------------------------/////////////////////////////////////
...
///////////////////////////--------左侧变色--------------------////////////////////////////
//            if(left.fixed){
//                left.setTexture("res/lightPic/straight_fixed_light.png");
//            }else{
//                left.setTexture("res/lightPic/straight_light.png");
//            }
//            left.setRotation(90);
/////////////////--------------左侧变色结束------------------------/////////////////////////////////////
...
///////////////////////////--------右侧变色--------------------////////////////////////////
//            if(right.fixed){
//                right.setTexture("res/lightPic/curly_fixed_light.png");
//            }else{
//                right.setTexture("res/lightPic/curly_light.png");
//            }
...
///////////////////////////--------右侧变色--------------------////////////////////////////
//            if(right.fixed){
//                right.setTexture("res/lightPic/straight_fixed_light.png");
//            }else{
//                right.setTexture("res/lightPic/straight_light.png");
//            }
...
//////////////////--------------上侧变色--------------------////////////////////////////
//            if(up.fixed){
//                up.setTexture("res/lightPic/straight_fixed_light.png");
//            }else{
//                up.setTexture("res/lightPic/straight_light.png");
//            }
//            up.setRotation(0);
////////////////--------------------------------------/////////////////////////////////////
...
///////////////////////////--------上侧变色--------------------////////////////////////////
//            if(up.fixed){
//                up.setTexture("res/lightPic/curly_fixed_light.png");
//            }else{
//                up.setTexture("res/lightPic/curly_light.png");
//            }
//            up.setRotation(180);
//////////////////////////-----------------------------------/////////////////////////////////////
...
//////////////////----------------下侧变色--------------------////////////////////////////
//            if(down.fixed){
//                down.setTexture("res/lightPic/straight_fixed_light.png");
//            }else{
//                down.setTexture("res/lightPic/straight_light.png");
//            }
//            down.setRotation(0);
///////////////---------------------------------------/////////////////////////////////////
...
///////////////////////////--------下侧变色--------------------////////////////////////////
//            if(down.fixed){
//                down.setTexture("res/lightPic/curly_fixed_light.png");
//            }else{
//                down.setTexture("res/lightPic/curly_light.png");
//            }
//            down.setRotation(270);
//////////////////////////-----------------------------------/////////////////////////////////////
            if(down==this.mainnode){
                this.afterConnect();
            }else
...
/////////////////////----------------下侧变色结束-------------------/////////////////////////////////////
            ...
            for (var j = 0; j < Constant.levelSize[this.level][1]; j++) {
                for(var k = 0; k<this.nodelist.length; k++){
                    ...
                    if(k == this.nodelist.length-1&& this.map[i][j].type<7)
                        this.map[i][j].runAction(cc.fadeOut(1));
                        this.map[i][j].retain();
                }
            }
        }
    ...
    eliminateSelf: function () {//消除自己
        for(var i=0;i<this.nodelist.length;i++){
            this.nodelist[i].runAction(cc.fadeOut(1));
        }
    },
