...
var GameLayer = cc.Layer.extend({
    ...
    isConnect: function (node) {//是否成环
        ...
        var type = node.type;
        switch(type){
            case 1:this.checkRight(node);break;
            case 2:this.checkRight(node);break;
            case 3:this.checkDown(node);break;
            case 4:this.checkUp(node);break;
            case 5:this.checkRight(node);break;
            case 6:this.checkDown(node);break;
            default : break;
        }
    },
